...
const VerifyOtpv = () => {
    ...
    return (
        <>
            ...
            <div className="relative flex min-h-[80vh] flex-col justify-center overflow-hidden bg-gray-50 py-12">
                        ...
                        <div>
                            <form action="" method="post">
                                <div className="flex flex-col space-y-16">
                                    <div className="flex flex-row items-center justify-between gap-4 mx-auto w-full max-w-xs">
